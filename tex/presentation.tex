...
\setbeamercolor{title separator}{fg=tracker,bg=tracker}
...
\setbeamertemplate{title page}{
	\begin{minipage}[b][\paperheight]{\textwidth}
		...
		\begin{tabularx}{0.795\textwidth}{@{\hspace{0.205\textwidth}}Xr@{}}
			...
			\textcolor{gray}{Fakultät für Mathematik} & Prof. Dr. Johannes Schöning\\
			\textcolor{gray}{und Informatik} & Dmitry Alexandrovsky\\
		\end{tabularx}
		\vfill
		\vspace*{3mm}
	\end{minipage}
